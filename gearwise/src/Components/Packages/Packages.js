                    ...
                    <div className="col-md-4">
                        <div className="price-item">
                            <div className="price-header">
                                ...
                                <h2><span>Rs.</span><strong>7,400</strong><span>.00</span></h2>
                            </div>
                    ...
                    <div className="col-md-4">
                        <div className="price-item featured-item">
                            <div className="price-header">
                                ...
                                <h2><span>Rs.</span><strong>10,300</strong><span>.00</span></h2>
                            </div>
                            <div className="price-body">
                                <ul>
                                    <li><i className="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div className="col-md-4">
                        <div className="price-item">
                            <div className="price-header">
                                ...
                                <h2><span>Rs.</span><strong>14,500</strong><span>.00</span></h2>
                            </div>
                            <div className="price-body">
                                <ul>
                                    <li><i className="far fa-check-circle"></i>Seats Washing</li>
