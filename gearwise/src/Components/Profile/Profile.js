...
<div className='max-w-4xl px-4 py-10 sm:px-6 lg:px-8 mx-auto'>
                            ...
                            <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div className="sm:col-span-9">
                                    <div className="flex items-center gap-5">
                                        <img className="inline-block size-16 rounded-full ring-2 ring-white dark:ring-neutral-900" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREeI5zQoOFGIJQXWl_ItCe38hHShXWGs7GyAJb9SOFBK-ksdiBtp0i8TNpr4S5WgPucoo&usqp=CAU" alt="Image Description" />
                ...
                <>
                    <div className="container-xxl py-5   shadow p-4 sm:p-7 dark:bg-neutral-800 margin: 250px">
