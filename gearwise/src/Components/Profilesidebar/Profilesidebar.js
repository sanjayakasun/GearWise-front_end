  ...
  return (
    <div>
      ...
      <aside
        id="nav-menu-4"
        aria-label=""
        className={`fixed top-0 bottom-0 left-0 z-40 flex flex-col border-r border-r-slate-200 bg-white transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-3">
          <div
            ...
            role="alert"
          >
            <h3 className="mb-2 font-semibold center">My Profile</h3>
            {/* <p>
        ...
        <footer className="border-t border-slate-200 p-3">
          <a
            href="#"
            className="flex items-center gap-3 rounded p-3 text-slate-900 transition-colors hover:text-indigo-500 "
          >
            <div className="flex items-center self-center ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
