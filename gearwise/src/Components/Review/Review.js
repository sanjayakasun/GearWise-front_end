        ...
        <section class="max-w-4xl p-6 mx-auto bg-gray-200 rounded-md shadow-md dark:bg-gray-800">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div class="flex justify-end mt-6">
              <button type="submit" class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-blue-600">Submit</button>
            </div>
          </form>
        </section>
      </div>
