...
const Appoinmnet = () => {
  ...
  <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
    <div className="flex items-center gap-x-3">
      ...
      <td className="size-px whitespace-nowrap">
        <div className="px-6 py-3">
          <span className="text-sm text-gray-500 dark:text-neutral-500">6.00pm-7.00pm </span>
        </div>
      </td>
      <td className="size-px whitespace-nowrap">
            <div className="px-6 py-3">
  ...
  <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
    <div className="flex items-center gap-x-3">
      ...
      <td className="size-px whitespace-nowrap">
        <div className="px-6 py-3">
          <span className="text-sm text-gray-500 dark:text-neutral-500">7.00pm-8.00pm</span>
        </div>
      </td>
